...
export const Layout: FC<{ showFooter?: boolean; children: Child }> = (
  props,
) => {
  return (
    <html>
          ...
          <header class="mb-8">
            <nav class="flex items-center justify-between">
              ...
              <div class="flex gap-4">
                ...
                <a href="/energy" class="hover:underline underline-offset-4">
                  Energy
                </a>
                <a href="/system" class="hover:underline underline-offset-4">
                  System
                </a>
                <a
                  href="https://x.com/thomas_ankcorn"
                  target="_blank"
        ...
        {props.showFooter && (
          <footer class="mt-16 py-8 px-4 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-gray-800 text-sm text-gray-500 dark:text-gray-400 flex items-center justify-between">
            ...
            <div class="flex gap-4">
              ...
              <a
                href="https://www.linkedin.com/in/thomas-ankcorn-370889151/"
                target="_blank"
                rel="noopener noreferrer"
                class="hover:text-gray-700 dark:hover:text-gray-200"
              >
