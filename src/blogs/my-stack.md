...
The temptation to do `wrangler deploy` and be done is enormous (Cloudflare is literally my employer and it is quite marvelous). But my friend [Sean Tracey](https://smt.codes) gave me a Raspberry Pi, and that was enough to ruin my financial judgement.
